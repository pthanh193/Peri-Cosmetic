        ...
        try {
            ...
            if (result.error) {
                ...
                if (result.paymentIntent.status === 'succeeded') {
                    ...
                    alert.error('Đã xảy ra lỗi trong quá trình thanh toán')
                }
            }
        ...
        <Fragment>
            ...
            <div className="row wrapper">
                ...
                <form className="shadow-lg" onSubmit={submitHandler}>
                    <h1 className="mb-4 text-center">Thông tin thẻ</h1>
                    ...
                    >
                    Thanh toán 
                    (-<CurrencyFormat value={orderInfo.totalPrice} displayType={'text'} thousandSeparator={true}/>đ)
                    </button>
